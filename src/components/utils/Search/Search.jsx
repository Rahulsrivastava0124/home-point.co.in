...
export default function Search({
    ...
    useEffect(() => {
        ...
        setIsDropdownVisible(false);
    }, [isSearching, hasSearched, locationValue, configurationValue, autoHideMs, searchResults, searchError]);
    ...
    return (
        <div className="mt-20 mx-1 relative">
            ...
            {(hasSearched || isSearching) && (locationValue || configurationValue) && isDropdownVisible && (
